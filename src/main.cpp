      ...
      if (sdata.size() > 2 && sdata[0] == '4' && sdata[1] == '2') {
        ...
        if (s != "") {
          ...
          if (event == "telemetry") {
            ...
            // Account for latency by predicting where the car will be
            ...
            /*
             * Calculate the steering angle and throttle using MPC.
             *
            ...
            // Add predicted Green line points
            ...
            // Add reference Yellow line points
            double x_interval = 2.5;
            int nPoints = 25;
            for (int i = 1; i < nPoints; i++)
            {
              double predict_x = x_interval*i;
              next_x_vals.push_back(predict_x);
              next_y_vals.push_back(polyeval(coeffs, predict_x));
            }
